# Issue 005: Close The Evaluation, Critique, And Release Loop
...
Add the evaluation-and-critique reference, run every baseline scenario with the
completed skill, and produce a reviewable Foundry-skill evidence report.
Deterministic checks and fresh-agent behavior must prove correct routing,
contracts, design decisions, authority boundaries, target-project write plans,
and downstream release requirements. Disposable target repositories may expose
behavior, but no generated application is committed or claimed released here.

Use the post-revamp derived canonical catalog for discovery. Do not restore or
extend a competing hand-maintained skill inventory.
...
- `workflow-foundry-015-issue-003-domain-interface-and-states`
- `workflow-foundry-015-issue-004-local-runtime-and-package-boundaries`

## User stories covered

- 44-50. Product tests, mixed graders, verification evidence, RED skill development, prompt economy, language coverage, and permanent regressions.
